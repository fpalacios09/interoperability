...
### En Placas ESP32
Clonar el repositorio en una PC con Arduino IDE y cargar los respectivos códigos Arduino a cada placa. Antes de subir el código a cada placa, cambiar la IP por una dirección dentro de la misma subred que la Raspberry Pi, sin repetir direcciones de otros dispositivos de la red.
